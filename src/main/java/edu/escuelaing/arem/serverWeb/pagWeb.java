...
/**
 * This class creates and modifies the header HTTP/1.1
 * to display png images or html pages. 
 * @author camilolopez
 */
public class pagWeb {
    ...
    /**
     * This method edits the header if this want to display
     * an image or a html page, and convert the header and the
     * image or page to bytes to be displayed on the browser.
     * @param param
     * @throws IOException 
     */
    ...
    /**
     * This method creates the bytes of each one of the objetcs
     * i.e the header and the web page or png image.
     * @throws IOException 
     */
